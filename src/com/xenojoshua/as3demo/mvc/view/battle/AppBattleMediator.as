	...
	public class AppBattleMediator extends XafRobotlegsMediator
	{
		...
		private function startBattle():void {
			...
			var attackers:Array = [
				...
				new AppBattleSoldier(3, '102', 3000, 1000, 200, true, false, 0),
				new AppBattleSoldier(1, '100', 3000, 1000, 200, true, false, 1),
				new AppBattleSoldier(2, '101', 3000, 1000, 200, true, true, 2)
			];
			var defenders:Array = [
				// griId: roleId, hp, attack, defence, isAttacker, isMagic, skillId
				new AppBattleSoldier(3, '001', 3000, 1000, 200, false, false, 0),
				new AppBattleSoldier(1, '102', 3000, 1000, 200, false, false, 1),
				new AppBattleSoldier(5, '101', 3000, 1000, 200, false, true, 2)
			];
